...
VALUES 
('Test User', 'test@example.com', '+33123456789', 'Test Company', ARRAY['Design Graphique', 'Web & Digital'], 'moins-5k', 'urgent', 'Ceci est une demande de test.', 'nouveau');
